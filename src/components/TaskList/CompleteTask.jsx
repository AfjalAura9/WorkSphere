...
const CompleteTask = ({ data }) => {
  ...
  return (
    <>
      <div
        className={`bg-green-100 p-6 rounded-lg shadow-lg flex flex-col gap-2 cursor-pointer ${CARD_WIDTH} ${CARD_HEIGHT}`}
      ...
      >
        ...
        <button className="bg-green-600 text-white px-5 py-2 rounded-lg text-sm w-full mt-auto">
          Completed
        </button>
      </div>
      {showModal && (
