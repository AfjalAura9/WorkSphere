...
const CompleteTask = ({ data }) => {
  return (
    <div className="min-w-[300px] bg-green-100 p-6 rounded-lg shadow-lg transition transform hover:scale-105">
      ...
      <button className="bg-green-600 hover:bg-green-700 text-white px-5 py-2 rounded-lg text-sm w-full transition ease-in-out duration-200">
        Completed
      </button>
    </div>
  );
